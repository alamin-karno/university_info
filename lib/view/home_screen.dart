...
import 'package:university_info/provider/get_university_provider.dart';
import 'package:university_info/widgets/shimmer_loading.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchUniversityList() async {
    final dataProvider =
        Provider.of<GetUniversityProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<GetUniversityProvider>(context);
    return Scaffold(
      appBar: AppBar(
        ...
        title: isSearch
            ...
            : Text(
                'Top University\'s of ${widget.name}',
